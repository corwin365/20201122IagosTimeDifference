...
%which parts to run?
%this is just a list of programme components in order - 1 to run, 0 to skip
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if MasterSettings.Run(1) == 1;
  ...
  %notification
  disp('--------------------------------------')
  disp(' Airport geolocation skipped      ')
  disp('--------------------------------------')
...
if MasterSettings.Run(2) == 1;
  ...
  %notification
  disp('--------------------------------------')
  disp(' Flight metadata computation skipped ')
  disp('--------------------------------------')
  
end

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% 3. rearrange data into routes
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
